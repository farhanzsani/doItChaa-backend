...
const swaggerSpec = {
    ...
    info: {
        title: 'Do It Cha API',
        version: '1.0.0',
        description: 'REST API for Do It Cha â€” a productivity app with personal task management and amigurumi price estimation.',
...
function setupSwagger(app, guard) {
    ...
    app.get('/admin', guard, (_req, res) => {
        res.sendFile(path_1.default.join(process.cwd(), 'public', 'docs.html'));
    });
}
